...
<body>
    ...
    <form method="post" action="#" id="form1">
        ...
        <section class="content-inner">
            <div class="container">
                <div class="ser-1">
                    <input name="ctl00$ContentPlaceHolder1$txtid" type="text" value="4"
                        id="ContentPlaceHolder1_txtid" />
                    <input type="submit" name="ctl00$ContentPlaceHolder1$btnAll" value="Abc"
                        id="ContentPlaceHolder1_btnAll" />
                </div>
                            ...
                            <li class='card-container  col-lg-2 col-md-6 col-sm-6 col-xs-6  C4'><a
                                    ...
                                    <div class='dlab-box dlab-overlay-box style-1 m-b30'>
                                        <div class='dlab-media dlab-img-overlay1 primary'> <img alt='img'
                                            ...
                                            <div class='dlab-info'> MSME Enrollment</div>
                                        </div>
                                    </div>
                                </a></li>
                            <li class='card-container  col-lg-2 col-md-6 col-sm-6 col-xs-6  C4'><a
                                    ...
                                    <div class='dlab-box dlab-overlay-box style-1 m-b30'>
                                        <div class='dlab-media dlab-img-overlay1 primary'> <img alt='img'
                                            ...
                                            <div class='dlab-info'> PAncard API Enroll</div>
                                        </div>
                                    </div>
                                </a></li>
                            <li class='card-container  col-lg-2 col-md-6 col-sm-6 col-xs-6  C4'><a
                                    ...
                                    <div class='dlab-box dlab-overlay-box style-1 m-b30'>
                                        <div class='dlab-media dlab-img-overlay1 primary'> <img alt='img'
                                            ...
                                            <div class='dlab-info'> Ration Card Enrollment</div>
                                        </div>
                                    </div>
                                </a></li>
                            <li class='card-container  col-lg-2 col-md-6 col-sm-6 col-xs-6  C4'><a
                                    ...
                                    <div class='dlab-box dlab-overlay-box style-1 m-b30'>
                                        <div class='dlab-media dlab-img-overlay1 primary'> <img alt='img'
                                            ...
                                            <div class='dlab-info'> RC/RTO Mobile No Update API</div>
                                        </div>
                                    </div>
                                </a></li>
                            <li class='card-container  col-lg-2 col-md-6 col-sm-6 col-xs-6  C4'><a
                                    ...
                                    <div class='dlab-box dlab-overlay-box style-1 m-b30'>
                                        <div class='dlab-media dlab-img-overlay1 primary'> <img alt='img'
                                            ...
                                            <div class='dlab-info'> Virtual Account Create</div>
                                        </div>
                                    </div>
                                </a></li>
                            <li class='card-container  col-lg-2 col-md-6 col-sm-6 col-xs-6  C4'><a
